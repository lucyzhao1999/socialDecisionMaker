...
def main():
    ...
    plt.ylabel("help prob")
    plt.xlabel("ability score")
    plt.title('reward ='+ str(helpingReward) + ' cost ='+ str(helpingCost)+ ' boostIndex ='+ str(reputBoostIndex) + ' hurtIndex ='+ str(reputHurtIndex))
    plt.ylim(-0.1, 1.1)
    plt.show()
...
##############################################################
    ...
    # plt.ylim(-0.1, 1.1)
    # plt.title('helpingReward ='+ str(helpingReward) + ' helpCost ='+ str(helpingCost) + ' agentAbility ='+ str(agentAbilityScore) + ' helpReward =' + str(helpingReward))
    # plt.show()
    #
    #
